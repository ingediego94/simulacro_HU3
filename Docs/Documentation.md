...
donet ef migrations asd NameMigration --project projName.Infrastructure --startup-project projName.Api | To do a migration |
donet ef database update --project projName.Infrastructure --startup-project projName.Api |To create the DB |
dotnet new gitignore | To create gitignore file |
docker compose build | sirve para construir (build) las imágenes Docker definidas en tu archivo docker-compose.yml o compose.yaml |
